...
namespace EYM.Presentation.Admin.Controllers
{
    public class RolesController : Controller
    {
        ...
        {
            var rols = db.Rols.Include(r => r.Users);
        ...
        {
            ViewBag.RoleId = new SelectList(db.Users, "UserId", "FirstName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "RoleId,Name")] Role role)
        {
            ...
            ViewBag.RoleId = new SelectList(db.Users, "UserId", "FirstName", role.RoleId);
            return View(role);
        }
